...
$(document).ready(function(){
    ...
    $('#profileImageInput').on('change', function() {
        ...
        if (file) {
            ...
            $.ajax({
                url: '/image-profile', // Replace with your actual upload endpoint
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    $('.subac').click(function(){
        ...
        // if (pandocument.val().trim() === '') {
           
        //     triggerAlert('Please select PAN card file.','error');
        //     pandocument.focus();
        //     return;
        // }

        // if (bankstatement.val().trim() === '') {
           
        //     triggerAlert('Please select bank first page file.','error');
        //     bankstatement.focus();
        //     return;
        // } 
