								...
								<tbody>
                                    @if(!empty($get_ltr_details))
                                        ...
                                        <tr>
                                            ...
                                            <td>{{strtoupper($ltrdetails->travelid)}}</td>
                                            <td>{{$ltrdetails->traveldate}}</td>
                                            <td>{{$ltrdetails->travel_reason}}</td>
                                            <td>{{$ltrdetails->travel_mode}}</td>
                                            <td>{{$ltrdetails->travel_amount}}</td>
                                            <td>

                                            @if($ltrdetails->doc)
                                                @if(pathinfo($ltrdetails->doc, PATHINFO_EXTENSION) == 'pdf')
                                                    <a href="{{url('public/uploads/localtravel')}}/{{$ltrdetails->doc}}" class="image-popup">
                                                ...
                                                <a href="{{url('public/uploads/localtravel')}}/{{$ltrdetails->doc}}" class="image-popup">
                                                    <img style="width:50px; height:50px" src="{{url('public/uploads/localtravel')}}/{{$ltrdetails->doc}}" alt=""
                                                    ></a>
                                                @else
