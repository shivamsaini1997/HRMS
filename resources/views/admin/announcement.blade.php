								...
								<table class="table table-striped custom-table mb-0 datatable">
									...
									<tbody>
										@if(!empty($get_announcement))
											@foreach($get_announcement as $announcement)
											<tr>
												<td>{{$announcement->id}}</td>
												<td>{{$announcement->created_at}}</td>
												<!-- <td>-</td> -->
												<td class="announce-title-td announce-td">{!! $announcement->title !!}</td>
												<td class="announcment-dec-td announce-td">{!! $announcement->description !!}</td>
												<td class="text-end">
													<div class="dropdown dropdown-action">
														<a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item ea" href="#" data-bs-toggle="modal" data-id="{{$announcement->id}}" data-bs-target="#edit_announcement"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
															<a class="dropdown-item dl-anc" href="#" data-id="{{$announcement->id}}" data-bs-toggle="modal" data-bs-target="#delete_announcement"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
														</div>
													</div>
												</td>
											</tr>
