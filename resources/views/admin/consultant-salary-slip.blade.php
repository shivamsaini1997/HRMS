						...
						<div class="row align-items-center">
							...
							<div class="col-auto float-end ms-auto">
								<div class="btn-group btn-group-sm">
									...
									<a class="btn btn-white print-slip" id="print-pdf" href="{{url('admin/consultant-salary/generate-pdf')}}/{{$getall_emp_salary->emp_id}}/{{$getall_emp_salary->id}}"><i class="fa-solid fa-print fa-lg"></i> Print</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<tbody>
									...
									<h4 class="payslip-title">Payslip for the month of {{ \Carbon\Carbon::createFromFormat('Y-m-d', $getall_emp_salary->sal_month)->format('F Y') }}</h4>
									<div class="row">
										<div class="col-12 text-center border-top border-bottom py-2">
											<h4 class="m-0">{{$getall_emp_salary->firstname}} {{$getall_emp_salary->lastname}}</h4>
										...
										<div class="col-lg-6 m-b-20 mt-3">
											<div class="invoice-details">
												...
												<ul class="list-unstyled">
													<li>Salary Month: <span>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $getall_emp_salary->sal_month)->format('F Y') }}</span></li>
												</ul>
											</div>
										</div>
									</div>
									<div class="" style="display:flex;">
										<div class="col-lg-6 m-b-20" style="padding: 0 7px; width:50%">
											<ul class="list-unstyled">
												<li>
													<h5 class="mb-0"><strong>Department</strong> <span>{{$getall_emp_salary->dept}}</span></h5>
												</li>
												<li>
													<h5 class="mb-0"><strong>Gender</strong> <span>{{$getall_emp_salary->gender}}</span></h5>
												</li>
												<li>
													<h5 class="mb-0"><strong>PAN</strong> <span>{{$getall_emp_salary->panno}}</span></h5>
												</li>
												<li>
													<h5 class="mb-0"><strong>Days  Payable</strong> <span>{{$getall_emp_salary->payable_days}}</span></h5>
												</li>
												<li>
													<h5 class="mb-0"><strong>DOJ</strong> <span>{{$getall_emp_salary->doj}}</span></h5>
												</li>
												<li>
													<h5 class="mb-0"><strong>A/C No.</strong> <span>{{$getall_emp_salary->bankaccount}}</span></h5>
												</li>
												<li>
										...
										<div class="col-lg-6 m-b-20" style="padding: 0 7px; width:50%">
											<ul class="list-unstyled">
												<li>
													<h5 class="mb-0"><strong>Emp. code</strong> <span>{{$getall_emp_salary->emp_id}}</span></h5>
												</li>
												<li>
													<h5 class="mb-0"><strong>Designation</strong> <span>{{$getall_emp_salary->design}}</span></h5>
												</li>
												<li>
												...
												<table class="table table-bordered">
													...
													<tbody>
														<tr>
															...
															<td><span class="float-end">{{$getall_emp_salary->consolidated_fee}}</span></td>
															
															<td>TDS</td>
															<td><span class="float-end">{{$getall_emp_salary->tds}}</span></td>
													...
													<thead>
														<tr>
															<th>Gross Pay (A)</th>
															<th class="text-end">{{$getall_emp_salary->net_pay}}</th>
															<th>Gross Deductions(B)</th>
															<th class="text-end">{{$getall_emp_salary->tds}}</th>
														</tr>
													</thead>
													<tbody style="border-bottom: 5px double;">
														<tr>
															...
															@endphp
															<td><span class="float-end">{{$getall_emp_salary->net_pay}} (in words)</span></td>
															<td>Rs. {{ucfirst($words)}}.</td>
...
<script>
    ...
    //     $.get('{{ URL::to('admin/consultant-salary/generate-pdf') }}', function(response) {
