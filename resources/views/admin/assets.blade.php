										...
										@if(!empty($all_assets))
											@foreach($all_assets as $assets)
												<tr>
													...
													<td>{{$assets->purchase_from}}</td>
													<td>{{$assets->modelid}}</td>
													...
													<td class="text-center">
														<div class="dropdown action-label">
															...
															<div class="dropdown-menu dropdown-menu-right status-dropdown">
																<a class="dropdown-item" asset-id="{{$assets->id}}" uid="{{$assets->userid}}" data-status="P" href="#">Pending</a>
																<a class="dropdown-item" asset-id="{{$assets->id}}" uid="{{$assets->userid}}" data-status="A" href="#">Approved</a>
																<a class="dropdown-item" asset-id="{{$assets->id}}" uid="{{$assets->userid}}" data-status="R" href="#">Returned</a>
																<a class="dropdown-item" asset-id="{{$assets->id}}" uid="{{$assets->userid}}" data-status="D" href="#">Damaged</a>
															</div>
														</div>
													</td>
													<td class="text-end">
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item edit-ase" href="#" data-bs-toggle="modal" data-bs-target="#edit_asset" data-id="{{$assets->id}}" data-us-id="{{$assets->userid}}"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
																<a class="dropdown-item dl-esse" href="#" data-bs-toggle="modal" data-bs-target="#delete_asset" data-id="{{$assets->id}}" data-us-id="{{$assets->userid}}"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
															</div>
														</div>
													</td>
												</tr>
