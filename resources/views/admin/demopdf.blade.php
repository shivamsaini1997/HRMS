            ...
            <tbody >
                <tr style="padding:0px; text-align:center;">
                    ...
                    <img src="{{ public_path('Access-assist-logo-01.png') }}" style="width: 100px; height: 100px;">
                        <h4 class="payslip-title" style="font-family: 'Roboto', sans-serif;">Payslip for the Month of {{ \Carbon\Carbon::createFromFormat('Y-m-d', $getall_emp_salary->sal_month)->format('F Y') }}</h4>
                    </td>
                </tr>
                <tr style="text-align:center; padding:0px;">
                    <td style="padding:10px 0px; border-bottom:1px solid #dee2e6; border-top:1px solid #dee2e6; margin-top:40px; font-family: 'Roboto', sans-serif;"> 
                        <b>{{$getall_emp_salary->firstname}} {{$getall_emp_salary->lastname}}</b>
                    </td>
                </tr>
                <tr>
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <h3 class="text-uppercase" style="font-family: 'Roboto', sans-serif; margin:-0px;font-size:14px;"><b>Payslip #{{$getall_emp_salary->id}}</b></h3>
                                    <p style="font-family: 'Roboto', sans-serif;  margin-top:5px; font-size:14px;"> Salary Month: <span>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $getall_emp_salary->sal_month)->format('F Y') }}</span></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <table style="width:100%; border-spacing: 0;">
                            <tbody>
                                <tr style="padding:0px;">
                                    ...
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->dept}}</td>
                                </tr>
                                <tr style="padding:0px;">
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; font-family: 'Roboto', sans-serif; font-size:14px;"><b>Gender</b></td>
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->gender}}</td>
                                </tr>
                                <tr style="padding:0px;">
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; font-family: 'Roboto', sans-serif; font-size:14px;"><b>PAN</b></td>
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->panno}}</td>
                                </tr>
                                <tr style="padding:0px;">
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; font-family: 'Roboto', sans-serif; font-size:14px;"><b>Days Payable</b></td>
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->payable_days}}</td>
                                </tr>
                                <tr style="padding:0px;">
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; font-family: 'Roboto', sans-serif; font-size:14px;"><b>DOJ</b></td>
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->doj}} </td>
                                </tr>
                                <tr style="padding:0px;">
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; font-family: 'Roboto', sans-serif; font-size:14px;"><b>A/C No. </b></td>
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->bankaccount}}</td>
                                </tr>
                        ...
                        <table style="width:100%; border-spacing: 0;">
                            <tbody>
                                <tr style="padding:0px;">
                                    ...
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->emp_id}}</td>
                                </tr>
                                <tr style="padding:0px;">
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; font-family: 'Roboto', sans-serif; font-size:14px;"><b>Designation</b></td>
                                    <td style="width:50%; border-spacing: 0; padding:2px 8px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->design}}</td>
                                </tr>
                                <tr style="padding:0px;">
                        ...
                        <table style="width:100%; border-spacing: 0;">
                            ...
                            <tbody>
                                <tr style="padding:0px;">
                                    ...
                                    <td style="border-top: 2px solid #000; border-bottom: 2px solid #000; border-spacing: 0; padding:5px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->consolidated_fee}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                        ...
                        <table style="width:100%; border-spacing: 0;">
                            ...
                            <tbody>
                                <tr style="padding:0px;">
                                    ...
                                    <td style="border-top: 2px solid #000; border-bottom: 2px solid #000; border-spacing: 0; padding:5px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->tds}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                        ...
                        <table style="width:100%; border-spacing: 0;">
                            <thead>
                                <tr style="font-family: 'Roboto', sans-serif; font-size:14px;">
                                    ...
                                    <th style="font-weight: 700;  border-spacing: 0; text-align: right;padding:5px;">{{$getall_emp_salary->net_pay}}</th>
                                </tr>
                            </thead>
                            <tbody>
                            @php 
                            ...
                            @endphp
                                <tr style="padding:0px;">
                                    ...
                                    <td style="border-top: 2px solid #000; border-spacing: 0; padding:5px; text-align: right; font-family: 'Roboto', sans-serif; font-size:14px;">{{$getall_emp_salary->net_pay}} (in words)</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                        ...
                        <table style="width:100%; border-spacing: 0;">
                            <thead>
                                <tr style="font-family: 'Roboto', sans-serif; font-size:14px;">
                                    ...
                                    <th style="font-weight: 700; border-spacing: 0; text-align: right;padding:5px;">{{$getall_emp_salary->tds}}</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr style="padding:0px;">
                                    <td style="border-top: 2px solid #000;  border-spacing: 0; padding:5px; font-family: 'Roboto', sans-serif; font-size:14px;">Rs. {{ucfirst($words)}}.</td>
