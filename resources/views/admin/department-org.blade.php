                    ...
                    <div class="col-md-12">
                        <div>
                            <table class="table table-striped custom-table mb-0 datatable">
                                ...
                                <tbody>
                                    @if($get_all_org != null)
                                        @foreach($get_all_org as $orgname)
                                            <tr>
                                                <td>{{$orgname->id}}</td>
                                                <td>{{$orgname->name}}</td>
                                                <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item editorg" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#edit_department" data-id="{{$orgname->id}}"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item del-org" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#delete_department" data-id="{{$orgname->id}}"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                                                    </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <div class="col-md-12">
                        <div>
                            <table class="table table-striped custom-table mb-0 datatable">
                                ...
                                <tbody>
                                    @if($get_all_dept != null)
                                        @foreach($get_all_dept as $all_dept)
                                            <tr>
                                                <td>{{$all_dept->id}}</td>
                                                <td>{{$all_dept->name}}</td>
                                                <td>{{$all_dept->dept_name}}</td>
                                                <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                        <a href="javascript:void(0)" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item edit-dept" href="javascript:void(0)" data-bs-toggle="modal" data-id="{{$all_dept->id}}" orgid="{{$all_dept->org_id}}" data-bs-target="#edit_department1"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item delete-dept" href="javascript:void(0)" data-bs-toggle="modal" data-id="{{$all_dept->id}}" orgid="{{$all_dept->org_id}}" data-bs-target="#delete_department1"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                                                    </div>
                                                    </div>
                                                </td>
                                            </tr>
