					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-striped custom-table mb-0 datatable">
								...
								<tbody>
								@if($all_assign_role != null)
											@foreach($all_assign_role as $role)
									<tr>
												...
												<td class="text-end">
													<div class="dropdown dropdown-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item del-rl" href="#" data-bs-toggle="modal" data-id="{{$role->admin_id}}" data-bs-target="#delete_role"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
														</div>
													</div>
												</td>
