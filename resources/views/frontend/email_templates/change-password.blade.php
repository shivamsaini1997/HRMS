            ...
            <div class="page">
                ...
                <div class="card" style="border-radius: 50px; background-color:#034AA6; padding:50px 20px; width:50%;">
                    ...
                    <div style="padding: 0 20px 0 20px ;">
                        ...
                        <p style="color:white;">Use your new password to log in.</p>

                         

                        <p style="color:white;">Username : <span id="username"><strong>{{$data['username']}}</strong></span></p>

                        <p style="color:white;">New Password : <span id="password"><strong>{{$data['password']}}</strong></span></p>
                    ...
                    <div>
                        ...
                        <h3 style="margin: 0 20px 20px 40px; color:white;">Thanks, <br><strong>HRMS Team</strong></h3>
