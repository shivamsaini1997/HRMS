                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <span id="greet"><b>Dear Mr./Mrs,</b> </span>{{$data['username']}} <br><br>
                                ...
                                Once updated, you can use the new email address to access your HRMS account.

                            </p>

                            <p class="card-text">Verification Code (OTP): <strong>{{$data['otp']}}</strong></p>

                            <p class="card-text">Validity: 10 minutes</p>

                            <p class="card-text text-danger">

                                Important note: Please do not share this code with anyone for the security of your HRMS account.
