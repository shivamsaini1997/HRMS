											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														<h3 class="user-name m-t-0 mb-0">{{$getuser->firstname}}</h3>
														...
														<div class="small text-muted">Joining date : @if($get_emp_details != null) {{$get_emp_details->doj}} @else -- @endif</div>
												...
												<div class="col-md-7">
													<ul class="personal-info">
														...
														<li>
															...
															<div class="text">@if($get_emp_details != null) {{$get_emp_details->dob}} @else -- @endif</div>
														</li>
														<li>
															<div class="title">Address:</div>
															<div class="text">@if($get_emp_details != null) {{$get_emp_details->address}} @else -- @endif</div>
														</li>
														<li>
															<div class="title">Gender:</div>
															<div class="text">@if($get_emp_details != null) {{$get_emp_details->gender}} @else -- @endif</div>
														</li>
										...
										<div class="card-body">
											...
											<ul class="personal-info">
												...
												<li>
													...
													<div class="text">@if($get_emp_details == null) -- @else {{$get_emp_details->nationality}} @endif</div>
												</li>
												<li>
													<div class="title">State</div>
													<div class="text">@if($get_emp_details == null) -- @else {{$get_emp_details->state}} @endif</div>
												</li>
												<li>
													<div class="title">Religion</div>
													<div class="text">@if($get_emp_details == null) -- @else {{$get_emp_details->religion}} @endif</div>
												</li>
												<li>
													<div class="title">Marital status</div>
													<div class="text">@if($get_emp_details == null) -- @else {{$get_emp_details->maritalstatus}} @endif</div>
												</li>
												
												<li>
													<div class="title">No. of children</div>
													<div class="text">@if($get_emp_details == null) -- @else {{$get_emp_details->noofchildren}} @endif</div>
												</li>
											</ul>
										</div>
									</div>
								...
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											...
											@if($get_emp_emargency_contact ==null)	
											...
											<ul class="personal-info">
												<li>
													...
													<div class="text">@if($get_emp_emargency_contact !=null) {{$get_emp_emargency_contact->primary_name}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">Relationship</div>
													<div class="text">@if($get_emp_emargency_contact !=null) {{$get_emp_emargency_contact->primary_relationship}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">Phone </div>
													<div class="text">@if($get_emp_emargency_contact !=null) {{$get_emp_emargency_contact->	primary_contact}} @else -- @endif</div>
												</li>
											</ul>
											<hr>
											...
											<ul class="personal-info">
												<li>
													<div class="title">Name</div>
													<div class="text">@if($get_emp_emargency_contact !=null) {{$get_emp_emargency_contact->secondary_name}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">Relationship</div>
													<div class="text">@if($get_emp_emargency_contact !=null) {{$get_emp_emargency_contact->secondary_relationship}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">Phone </div>
													<div class="text">@if($get_emp_emargency_contact !=null) {{$get_emp_emargency_contact->secondary_contact}} @else -- @endif</div>
												</li>
											</ul>
										</div>
									</div>
										...
										<div class="card-body">
											...
											<ul class="personal-info">
												<li>
													...
													<div class="text">@if($get_emp_bank_details != null){{$get_emp_bank_details->account_holder_name}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">Bank name</div>
													<div class="text">@if($get_emp_bank_details != null){{$get_emp_bank_details->bankname}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">Bank account No.</div>
													<div class="text">@if($get_emp_bank_details != null){{$get_emp_bank_details->bankaccount}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">IFSC Code</div>
													<div class="text">@if($get_emp_bank_details != null){{$get_emp_bank_details->ifsccode}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">PAN No</div>
													<div class="text">@if($get_emp_bank_details != null){{$get_emp_bank_details->panno}} @else -- @endif</div>
												</li>
												<li>
													<div class="title">PAN Documents</div>
													<div class="text"><img src="@if($get_emp_bank_details != null) {{url('public/uploads/pandocument')}}/{{$get_emp_bank_details->pandocument}} @endif" alt=""></div>
												</li>
												<li>
													<div class="title">Bank Statement</div>
													<div class="text"><img src="@if($get_emp_bank_details != null) {{url('public/uploads/bankstatement')}}/{{$get_emp_bank_details->bankstatement}} @endif" alt=""></div>
												</li>
											</ul>
										</div>
									</div>
...
<script src="{{asset('public/frontend/assets/js/profile.js')}}"></script>
