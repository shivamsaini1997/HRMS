                ...
                <div class="content container-fluid">
					...
					<div class="row" id="payslip-container">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									<h4 class="payslip-title">Payslip for the month of {{ \Carbon\Carbon::parse($getall_emp_salary->salary_month)->format('F Y') }}</h4>
									<div class="row">
										...
										<div class="col-sm-6 m-b-20">
											<div class="invoice-details">
												...
												<ul class="list-unstyled">
													<li>Salary Month: <span>{{ \Carbon\Carbon::parse($getall_emp_salary->salary_month)->format('F Y') }}</span></li>
												</ul>
											</div>
										</div>
									</div>
