                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-12 col-md-3 col-lg-2">
                            <div class="profile-img">
                                ...
                                @if($getuser->image == null) <p class="profile-user-name">{{strtoupper($getuser->firstname[0])}}</p> @else <img src="{{asset('public/uploads/profile-image')}}/{{$getuser->image}}" alt="" width="100%">@endif
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 d-flex justify-content-end">
                                        <div class="log-out">
                                            <a class="buttons mt-3" href="{{ route('logout')}}">Log Out</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-sm-12 col-md-9 col-lg-9">
            <form class="form" id="myform">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="@if(!empty($getuser->firstname)) {{$getuser->firstname}} @endif">
                    <span id="nameError" class="error"></span><br>
                </div>
                <div>
                    <label for="exampleInputPassword1" class="form-label">Phone Number</label>
                    <input type="text" class="form-control" id="phone" name="phone" value="@if(!empty($getuser->phone_no)) {{$getuser->phone_no}} @endif">
        ...
        <div class="col-sm-12 col-md-9 col-lg-9">
            <div class="change-pass-sec">
                ...
                <form action="" id="myform2">
                    <div>
                        <input type="email" class="form-control col-4" id="email" name="email" value="{{$getuser->email}}" disabled>
