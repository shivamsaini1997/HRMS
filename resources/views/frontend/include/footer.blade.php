...
<!-- jQuery -->
  <script src="{{asset('public/frontend/assets/js/jquery-3.7.1.min.js')}}"></script>
...
<!-- Slimscroll JS -->
<script src="{{asset('public/frontend/assets/js/jquery.slimscroll.min.js')}}"></script>
...
<!-- Datatable JS -->
<script src="{{asset('public/frontend/assets/js/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('public/frontend/assets/js/dataTables.bootstrap4.min.js')}}"></script>
<script src="{{asset('public/frontend/assets/plugins/lightbox/glightbox.min.js')}}"></script>
<script src="{{asset('public/frontend/assets/plugins/lightbox/lightbox.js')}}"></script>


<!-- Tagsinput JS -->
<script src="{{asset('public/frontend/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js')}}"></script>
<script src="{{asset('public/frontend/assets/js/jquery-ui.min.js')}}"></script>
<script src="{{asset('public/frontend/assets/js/fullcalendar.min.js')}}"></script>
<script src="{{asset('public/frontend/assets/js/jquery.fullcalendar.js')}}"></script>



 <!-- Theme Settings JS -->
<script src="{{asset('public/frontend/assets/js/layout.js')}}"></script>
<script src="{{asset('public/frontend/assets/js/theme-settings.js')}}"></script>
<script src="{{asset('public/frontend/assets/js/greedynav.js')}}"></script>
