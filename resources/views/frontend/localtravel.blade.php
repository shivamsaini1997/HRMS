										...
										<tbody>
											@if(!empty($get_ltr_details))
												@foreach($get_ltr_details as $travel_details)
													<tr>
														<td>{{strtoupper($travel_details->travelid)}}</td>
														<td>{{$travel_details->traveldate}}</td>
														<td>{{$travel_details->travel_reason}}</td>
														<td>{{$travel_details->	travel_mode}}</td>
														<td>{{$travel_details->travel_amount}}</td>
														<td>
															@if($travel_details->doc)
																@if(pathinfo($travel_details->doc, PATHINFO_EXTENSION) == 'pdf')
																	<a class="pdfmodallink" href="javascript:void(0)" type="button" data-bs-toggle="modal" data-bs-target="#pdfModal" data-src="{{url('public/uploads/localtravel')}}/{{$travel_details->doc}}">
																		<embed class="embedclick" src="{{url('public/uploads/localtravel')}}/{{$travel_details->doc}}" type="application/pdf" width="200" height="200" />
																	</a>
																@elseif(in_array(pathinfo($travel_details->doc, PATHINFO_EXTENSION), ['doc', 'docx']))
																	<a class="pdfmodallink" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#docModal" data-src="{{url('public/uploads/localtravel')}}/{{$travel_details->doc}}">
																...
																@elseif(in_array(pathinfo($travel_details->doc, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif']))
																	<a class="pdfmodallink" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#imageModal" data-src="{{url('public/uploads/localtravel')}}/{{$travel_details->doc}}">
																		<img class="embedclick" src="{{url('public/uploads/localtravel')}}/{{$travel_details->doc}}" alt="Image" width="200" height="200">
																	</a>
																@else
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<embed src="{{url('public/uploads/localtravel')}}/{{$travel_details->doc}}" type="application/pdf" width="100%" height="500px" />
															</div>
														</div>
													</div>
												</div>
												...
												<div class="modal fade" id="docModal" tabindex="-1" role="dialog" aria-labelledby="docModalLabel" aria-hidden="true">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<iframe src="{{url('public/uploads/localtravel')}}/{{$travel_details->doc}}" frameborder="0" width="100%" height="500px"></iframe>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel" aria-hidden="true">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<img src="{{url('public/uploads/localtravel')}}/{{$travel_details->doc}}" width="100%" />
															</div>
														</div>
													</div>
												</div>
