<?php echo $__env->make('frontend.include.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<style>
				...
				<div class="page-wrapper">
					...
					<div class="content container-fluid">
						...
						<div class="page-header">
							<div class="row align-items-center">
								<div class="col">
									<h3 class="page-title">Local Travel  </h3>
									<ul class="breadcrumb">
										<li class="breadcrumb-item"><a href="admin-dashboard.html">Dashboard</a></li>
										<li class="breadcrumb-item active">Local Travel </li>
									</ul>
								</div>
									...
									<table class="table table-striped custom-table mb-0 datatable">
										...
										<tbody>
											<?php if(!empty($get_ltr_details)): ?>
												<?php $__currentLoopData = $get_ltr_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $travel_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														<td><?php echo e(strtoupper($travel_details->travelid)); ?></td>
														<td><?php echo e($travel_details->traveldate); ?></td>
														<td><?php echo e($travel_details->travel_reason); ?></td>
														<td><?php echo e($travel_details->	travel_mode); ?></td>
														<td><?php echo e($travel_details->travel_amount); ?></td>
														<td>
															<?php if($travel_details->doc): ?>
																<?php if(pathinfo($travel_details->doc, PATHINFO_EXTENSION) == 'pdf'): ?>
																	<a class="pdfmodallink" href="javascript:void(0)" type="button" data-bs-toggle="modal" data-bs-target="#pdfModal" data-src="<?php echo e(url('public/uploads/localtravel')); ?>/<?php echo e($travel_details->doc); ?>">
																		<embed class="embedclick" src="<?php echo e(url('public/uploads/localtravel')); ?>/<?php echo e($travel_details->doc); ?>" type="application/pdf" width="200" height="200" />
																	</a>
																<?php elseif(in_array(pathinfo($travel_details->doc, PATHINFO_EXTENSION), ['doc', 'docx'])): ?>
																	<a class="pdfmodallink" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#docModal" data-src="<?php echo e(url('public/uploads/localtravel')); ?>/<?php echo e($travel_details->doc); ?>">
																		<img class="embedclick" src="word_icon.png" alt="Word Document" width="200" height="200">
																	</a>
																<?php elseif(in_array(pathinfo($travel_details->doc, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif'])): ?>
																	<a class="pdfmodallink" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#imageModal" data-src="<?php echo e(url('public/uploads/localtravel')); ?>/<?php echo e($travel_details->doc); ?>">
																		<img class="embedclick" src="<?php echo e(url('public/uploads/localtravel')); ?>/<?php echo e($travel_details->doc); ?>" alt="Image" width="200" height="200">
																	</a>
																<?php else: ?>
														...
														<td class="text-center">
																<p class="dropdown-item mb-0">
																	<?php if($travel_details->status == 'A'): ?>
																		<i class="fa-regular fa-circle-dot text-success"></i> Approved
																	<?php elseif($travel_details->status == 'R'): ?>
															...
															<td class="text-end">
																<div class="dropdown dropdown-action">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a class="dropdown-item trvdel" href="javascript:void(0)" data-bs-toggle="modal"  data-id="<?php echo e($travel_details->id); ?>" data-bs-target="#delete_travel"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
																	</div>
																</div>
															</td> 
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<embed src="<?php echo e(url('public/uploads/localtravel')); ?>/<?php echo e($travel_details->doc); ?>" type="application/pdf" width="100%" height="500px" />
															</div>
														</div>
													</div>
												</div>
												...
												<div class="modal fade" id="docModal" tabindex="-1" role="dialog" aria-labelledby="docModalLabel" aria-hidden="true">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<iframe src="<?php echo e(url('public/uploads/localtravel')); ?>/<?php echo e($travel_details->doc); ?>" frameborder="0" width="100%" height="500px"></iframe>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel" aria-hidden="true">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<img src="<?php echo e(url('public/uploads/localtravel')); ?>/<?php echo e($travel_details->doc); ?>" width="100%" />
															</div>
														</div>
													</div>
												</div>
					...
					<div id="add_asset" class="modal custom-modal fade" role="dialog">
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title">Add Local Travel</h5>
									<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="input-block mb-3">
													...
													<input class="form-control" name="tdate" id="tdate" type="date" value="" >
												</div>
											</div>
											<div class="col-md-6">
												<div class="input-block mb-3">
													<label class="col-form-label">Travel Reason</label>
													<textarea class="form-control" name="tr" id="tr" type="text" placeholder="Travel Reason" required></textarea>
												</div>
											</div>
											<div class="col-md-6">
												<div class="input-block mb-3">
													<label class="col-form-label">Travel Mode</label>
													<input class="form-control" name="tm" id="tm" type="text" placeholder="Travel Mode" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="input-block mb-3">
													<label class="col-form-label">Travel Amount</label>
													<input class="form-control" name="ta" id="ta" type="text" placeholder="Travel Amount" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="input-block mb-3">
													<label class="col-form-label">Travel Documents</label>
													<input class="form-control" name="td" id="td" type="file" placeholder="Travel Documents" required>
												</div>
											</div>
										</div>
                                        <div class="submit-section">
											<button type="button" class="btn btn-primary submit-btn traveldetailssubmit">Submit</button>
										</div>
									</form>
								</div>
							</div>
        ...
        $('.pdfmodallink').on('click', function(){
			...
			$(document).ready(function() {
				$('.traveldetailssubmit').click(function(event) {
					const tdate = $('#tdate');
					const tr = $('#tr');
					const tm = $('#tm');
					const ta = $('#ta');
					...
					if (tdate.val().trim() === '') {
						triggerAlert('Please enter your travel date.', 'error');
						tdate.focus();
						return;
					}
					if (tr.val().trim() === '') {
						triggerAlert('Please enter your travel reason.', 'error');
						tr.focus();
						return;
					}
					if (tm.val().trim() === '') {
						triggerAlert('Please enter your travel mode.', 'error');
						tm.focus();
						return;
					}
					if (ta.val().trim() === '') {
						triggerAlert('Please enter your travel amount.', 'error');
						ta.focus();
						return;
					}
					if (td.val().trim() === '') {
						triggerAlert('Please select your travel document.', 'error');
						td.focus();
						return;
					}
...
<?php /**PATH /home/accessas/public_html/hrms/resources/views/frontend/localtravel.blade.php ENDPATH**/ ?>