								...
								<tbody>
                                    <?php if(!empty($get_ltr_details)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e(strtoupper($ltrdetails->ltrid)); ?></td>
                                            <td><?php echo e($ltrdetails->date); ?></td>
                                            <td><?php echo e($ltrdetails->reason); ?></td>
                                            <td><?php echo e($ltrdetails->paidby); ?></td>
                                            <td><?php echo e($ltrdetails->amount); ?></td>
                                            <td>

                                            <?php if($ltrdetails->doc): ?>
                                                <?php if(pathinfo($ltrdetails->doc, PATHINFO_EXTENSION) == 'pdf'): ?>
                                                    <a href="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($ltrdetails->doc); ?>" class="image-popup">
                                                ...
                                                <a href="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($ltrdetails->doc); ?>" class="image-popup">
                                                    <img style="width:50px; height:50px" src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($ltrdetails->doc); ?>" alt=""
                                                    ></a>
                                                <?php else: ?>
...
<?php /**PATH /home/accessas/public_html/hrms/resources/views/admin/local-pay-reimbursement.blade.php ENDPATH**/ ?>