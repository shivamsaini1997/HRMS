            ...
            <div class="page">
                <div class="card" style="border-radius: 50px; background-color:#034AA6; padding:50px 20px; width:50%;">
                    ...
                    <div style="padding: 0 20px 0 20px ;">
                        ...
                        <p style="color:white;">Username : <span id="username"><strong><?php echo e($data['username']); ?></strong></span></p>
                        <p style="color:white;">Password : <span id="password"><strong><?php echo e($data['password']); ?></strong></span></p>
                    </div>
...
</html><?php /**PATH /home/accessas/public_html/elarning/resources/views/frontend/email_templates/signup_email_templates.blade.php ENDPATH**/ ?>