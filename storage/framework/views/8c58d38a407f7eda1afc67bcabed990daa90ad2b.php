...
<link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/alert.css')); ?>">
										...
										<?php if(!empty($getall_emp_salary)): ?>
											<?php $__currentLoopData = $getall_emp_salary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empsalary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr>
													...
													<td><a class="btn btn-sm btn-primary" href="<?php echo e(url('admin/salary')); ?>/<?php echo e(strtolower($empsalary->emp_id)); ?>/<?php echo e($empsalary->id); ?>">Generate Slip</a></td>
													<td class="text-end">
		...
		</script><?php /**PATH /home/accessas/public_html/hrms/resources/views/admin/salary.blade.php ENDPATH**/ ?>