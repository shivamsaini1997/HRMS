					...
					<div class="page-header">
						<div class="row">
							...
							<div class="col-lg-8 text-end">
								...
								<a href="#" class="btn add-btn  me-3 esalemp" data-id="<?php echo e($getuser->email); ?>" data-bs-toggle="modal" data-bs-target="#edit_salary-em"><i class="fa-solid fa-pencil"></i> Edit Salary</a>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="profile-view">
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														<h3 class="user-name m-t-0 mb-0"><?php echo e($getuser->firstname); ?> <?php echo e($getuser->lastname); ?></h3>
														...
														<div class="small text-muted">Joining date : <?php if($get_emp_details != null): ?> <?php echo e($get_emp_details->doj); ?> <?php else: ?> Null <?php endif; ?></div>
														<?php if($get_emp_details != null && $get_emp_details->salary_amt != null): ?>
															<div class="small doj text-muted">Salary : <?php echo e($get_emp_details->salary_amt); ?></div>
														<?php endif; ?>
														...
														<?php if($get_office_name != null): ?>
															<div class="small doj text-muted">Office Location : <?php echo e($get_office_name->city); ?></div>
														<?php endif; ?>
												...
												<div class="col-md-7">
													<ul class="personal-info">
														...
														<li>
															...
															<div class="text"><?php if($get_emp_details != null): ?> <?php echo e($get_emp_details->dob); ?> <?php else: ?> Null <?php endif; ?></div>
														</li>
														<li>
															<div class="title">Address:</div>
															<div class="text"><?php if($get_emp_details != null): ?> <?php echo e($get_emp_details->address); ?> <?php else: ?> Null <?php endif; ?></div>
														</li>
														<li>
															<div class="title">Gender:</div>
															<div class="text"><?php if($get_emp_details != null): ?> <?php echo e($get_emp_details->gender); ?> <?php else: ?> Null <?php endif; ?></div>
														</li>
										...
										<div class="pro-edit">
											<a data-bs-target="#profile_info" data-bs-toggle="modal" class="edit-icon editprof" data-id="<?php if($getuser != null): ?><?php echo e($getuser->userid); ?><?php endif; ?>" href="#"><i class="fa-solid fa-pencil"></i></a>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<h3 class="card-title">Personal Informations 
												<a href="#" class="edit-icon editpi" data-bs-toggle="modal" data-id="<?php if($getuser != null): ?><?php echo e($getuser->userid); ?><?php endif; ?>" data-bs-target="#personal_info_modal"><i class="fa-solid fa-pencil"></i></a>
											</h3>
											<ul class="personal-info">
												
												<li>
													<div class="title">Nationality</div>
													<div class="text"><?php if($get_emp_details == null): ?> Null <?php else: ?> <?php echo e($get_emp_details->nationality); ?> <?php endif; ?></div>
												</li>
												<li>
													<div class="title">State</div>
													<div class="text"><?php if($get_emp_details == null): ?> Null <?php else: ?> <?php echo e($get_emp_details->state); ?> <?php endif; ?></div>
												</li>
												<li>
													<div class="title">Religion</div>
													<div class="text"><?php if($get_emp_details == null): ?> Null <?php else: ?> <?php echo e($get_emp_details->religion); ?> <?php endif; ?></div>
												</li>
												<li>
													<div class="title">Marital status</div>
													<div class="text"><?php if($get_emp_details == null): ?> Null <?php else: ?> <?php echo e($get_emp_details->maritalstatus); ?> <?php endif; ?></div>
												</li>
												
												<li>
													<div class="title">No. of children</div>
													<div class="text"><?php if($get_emp_details == null): ?> Null <?php else: ?> <?php echo e($get_emp_details->noofchildren); ?> <?php endif; ?></div>
												</li>
											</ul>
										</div>
									</div>
									...
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<h3 class="card-title">Emergency Contact 
												<a href="#" class="edit-icon editec" data-id="<?php if($getuser != null): ?><?php echo e($getuser->userid); ?><?php endif; ?>" data-bs-toggle="modal" data-bs-target="#emergency_contact_modal"><i class="fa-solid fa-pencil"></i></a>
											</h3>
											<h5 class="section-title">Primary</h5>
											<ul class="personal-info">
												<li>
													<div class="title">Name</div>
													<div class="text"><?php if($get_emp_emargency_contact !=null): ?> <?php echo e($get_emp_emargency_contact->primary_name); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													<div class="title">Relationship</div>
													<div class="text"><?php if($get_emp_emargency_contact !=null): ?> <?php echo e($get_emp_emargency_contact->primary_relationship); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													<div class="title">Phone </div>
													<div class="text"><?php if($get_emp_emargency_contact !=null): ?> <?php echo e($get_emp_emargency_contact->	primary_contact); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
											</ul>
											<hr>
											...
											<ul class="personal-info">
												<li>
													<div class="title">Name</div>
													<div class="text"><?php if($get_emp_emargency_contact !=null): ?> <?php echo e($get_emp_emargency_contact->secondary_name); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													<div class="title">Relationship</div>
													<div class="text"><?php if($get_emp_emargency_contact !=null): ?> <?php echo e($get_emp_emargency_contact->secondary_relationship); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													<div class="title">Phone </div>
													<div class="text"><?php if($get_emp_emargency_contact !=null): ?> <?php echo e($get_emp_emargency_contact->secondary_contact); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
											</ul>
										</div>
									</div>
								...
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											...
											<a href="#" class="edit-icon editacd" data-bs-toggle="modal" data-id="<?php if($getuser != null): ?><?php echo e($getuser->userid); ?><?php endif; ?>" data-bs-target="#bank_contact_modal"><i class="fa-solid fa-pencil"></i></a>

											</h3>
											<ul class="personal-info">
												<li>
													<div class="title">Account Holder Name</div>
													<div class="text"><?php if($get_emp_bank_details != null): ?><?php echo e($get_emp_bank_details->account_holder_name); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													<div class="title">Bank name</div>
													<div class="text"><?php if($get_emp_bank_details != null): ?><?php echo e($get_emp_bank_details->bankname); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													<div class="title">Bank account No.</div>
													<div class="text"><?php if($get_emp_bank_details != null): ?><?php echo e($get_emp_bank_details->bankaccount); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													<div class="title">IFSC Code</div>
													<div class="text"><?php if($get_emp_bank_details != null): ?><?php echo e($get_emp_bank_details->ifsccode); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													<div class="title">PAN No</div>
													<div class="text"><?php if($get_emp_bank_details != null): ?><?php echo e($get_emp_bank_details->panno); ?> <?php else: ?> Null <?php endif; ?></div>
												</li>
												<li>
													...
													<div class="text">
														<a href="<?php if($get_emp_bank_details != null): ?> <?php echo e(url('public/uploads/pandocument')); ?>/<?php echo e($get_emp_bank_details->pandocument); ?> <?php endif; ?>" download>
														<?php if($get_emp_bank_details != null): ?>
														<img style="width:100px; height:100px;" src="<?php if($get_emp_bank_details != null): ?> <?php echo e(url('public/uploads/pandocument')); ?>/<?php echo e($get_emp_bank_details->pandocument); ?> <?php endif; ?>" data-bs-toggle="tooltip" data-bs-title="Click Here Download Document"  alt="">
												...
												<li>
													...
													<div class="text">
														<a href="<?php if($get_emp_bank_details != null): ?> <?php echo e(url('public/uploads/bankstatement')); ?>/<?php echo e($get_emp_bank_details->bankstatement); ?> <?php endif; ?>" download>
														<?php if($get_emp_bank_details != null): ?>
														<img style="width:100px; height:100px;" src="<?php if($get_emp_bank_details != null): ?> <?php echo e(url('public/uploads/bankstatement')); ?>/<?php echo e($get_emp_bank_details->bankstatement); ?> <?php endif; ?>" data-bs-toggle="tooltip" data-bs-title="Click Here Download Document"  alt="">
														<?php endif; ?>
														</a>
													</div>
												</li>
  	...
  	<div class="modal-dialog">
    	<div class="modal-content">
      		...
      		<div class="modal-body">
				...
				<input type="hidden" id="updateloc_emp_id" name="updateloc_emp_id" value="<?php echo e($getuser->email); ?>">
					<select class="form-control" name="ofl" id="ofl">
						<option value="">Select Office Location</option>
						<?php $__currentLoopData = $office_locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option value="<?php echo e($loc->id); ?>"><?php echo e($loc->city); ?></option>
...
<div class="modal fade" id="add_salary-em" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<form action="javascript:void(0)" method="post">
			<input type="hidden" id="emp_sal_id" name="emp_sal_id" value="<?php echo e($getuser->email); ?>">
...
<div class="modal fade" id="edit_salary-em" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<form action="javascript:void(0)" method="post">
			<input type="hidden" id="edit_emp_sal_id" name="edit_emp_sal_id" value="<?php echo e($getuser->email); ?>">
				<label for="">Employee Salary</label>
...
<script src="<?php echo e(asset('public/frontend/assets/js/edit-emp-profile.js')); ?>"></script>
...
<?php /**PATH /home/accessas/public_html/hrms/resources/views/admin/emp-profile.blade.php ENDPATH**/ ?>