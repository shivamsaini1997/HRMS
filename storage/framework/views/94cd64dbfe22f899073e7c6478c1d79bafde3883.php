...
<script>
  tinymce.init({
    ...
    ai_request: (request, respondWith) => respondWith.string(() => Promise.reject("See docs to implement AI Assistant")),
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="javascript:void(0)" method="post">
                                ...
                                <textarea name="travelpolicie" id="travelpolicie"><?php if($check_travel_policie_data != null): ?><?php echo e($check_travel_policie_data->policies); ?><?php endif; ?></textarea>
        ...
        </script><?php /**PATH /home/accessas/public_html/hrms/resources/views/admin/travelpolicies.blade.php ENDPATH**/ ?>