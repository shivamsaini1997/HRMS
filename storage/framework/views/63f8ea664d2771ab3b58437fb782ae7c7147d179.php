                ...
                <div class="content container-fluid">
					...
					<div class="row" id="payslip-container">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									<h4 class="payslip-title">Payslip for the month of <?php echo e($getall_emp_salary->salary_month); ?></h4>
									<div class="row">
										...
										<div class="col-sm-6 m-b-20">
											<div class="invoice-details">
												...
												<ul class="list-unstyled">
													<li>Salary Month: <span><?php echo e($getall_emp_salary->salary_month); ?></span></li>
												</ul>
											</div>
										</div>
									</div>
...
<script>
    $(window).on('load', function() {
        ...
        $.get('<?php echo e(URL::to('admin/emp-salary/generate-pdf')); ?>', function(response) {
            // Once the PDF is generated, trigger its download
            //window.location.href = response.download_link;
        });
    });
</script><?php /**PATH /home/accessas/public_html/hrms/resources/views/admin/salary-view.blade.php ENDPATH**/ ?>