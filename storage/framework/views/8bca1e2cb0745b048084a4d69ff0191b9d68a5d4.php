										...
										<tbody>
											<?php if(!empty($get_ltr_details)): ?>
												<?php $__currentLoopData = $get_ltr_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $travel_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														<td><?php echo e(strtoupper($travel_details->ltrid)); ?></td>
														<td><?php echo e($travel_details->date); ?></td>
														<td><?php echo e($travel_details->reason); ?></td>
														<td><?php echo e($travel_details->	paidby); ?></td>
														<td><?php echo e($travel_details->amount); ?></td>
														<td>
															<?php if($travel_details->doc): ?>
																<?php if(pathinfo($travel_details->doc, PATHINFO_EXTENSION) == 'pdf'): ?>
																	<a class="pdfmodallink" href="javascript:void(0)" type="button" data-bs-toggle="modal" data-bs-target="#pdfModal" data-src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($travel_details->doc); ?>">
																		<embed class="embedclick" src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($travel_details->doc); ?>" type="application/pdf" width="200" height="200" />
																	</a>
																<?php elseif(in_array(pathinfo($travel_details->doc, PATHINFO_EXTENSION), ['doc', 'docx'])): ?>
																	<a class="pdfmodallink" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#docModal" data-src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($travel_details->doc); ?>">
																...
																<?php elseif(in_array(pathinfo($travel_details->doc, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif'])): ?>
																	<a class="pdfmodallink" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#imageModal" data-src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($travel_details->doc); ?>">
																		<img class="embedclick" src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($travel_details->doc); ?>" alt="Image" width="200" height="200">
																	</a>
																<?php else: ?>
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<embed src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($travel_details->doc); ?>" type="application/pdf" width="100%" height="500px" />
															</div>
														</div>
													</div>
												</div>
												...
												<div class="modal fade" id="docModal" tabindex="-1" role="dialog" aria-labelledby="docModalLabel" aria-hidden="true">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<iframe src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($travel_details->doc); ?>" frameborder="0" width="100%" height="500px"></iframe>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel" aria-hidden="true">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-body">
																<img src="<?php echo e(url('public/uploads/localpay')); ?>/<?php echo e($travel_details->doc); ?>" width="100%" />
															</div>
														</div>
													</div>
												</div>
...
<?php /**PATH /home/accessas/public_html/hrms/resources/views/frontend/local-pay-reimbursement.blade.php ENDPATH**/ ?>