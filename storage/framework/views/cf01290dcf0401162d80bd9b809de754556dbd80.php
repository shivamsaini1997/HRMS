                ...
                <div class="content container-fluid">
					...
					<div class="row filter-row">
						...
						<div class="col-sm-6 col-md-1">
							<div class="d-grid">  
								<a href="<?php echo e(url('/admin/employees')); ?>" class="btn btn-secondary w-100"> Reset </a>  
							</div>  
						</div>
                    </div>
					<!-- Search Filter -->
					...
					<div class="row staff-grid-row">
						<?php $__currentLoopData = $all_emp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php
						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3 empdata">
							<div class="profile-widget">
								<div class="profile-img">
									<a href="<?php echo e(url('admin/employees/profile')); ?>/<?php echo e(strtolower($emp->emp_id)); ?>" class="avatar">
									<?php if($emp->image != null): ?>
										<img src="<?php echo e(url('public/uploads/profile')); ?>/<?php echo e($emp->image); ?> " alt="<?php echo e($emp->firstname); ?>">
									<?php else: ?>
								...
								<div class="dropdown profile-action">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item edit-emp" data-bs-toggle="modal" data-bs-target="#edit_employee" data-id="<?php echo e($emp->userid); ?>"><i class="fa-solid fa-pencil m-r-5"></i> Change Password</a>
										<a class="dropdown-item dl-emp" data-bs-toggle="modal" data-bs-target="#delete_employee"data-id="<?php echo e($emp->userid); ?>" data-email="<?php echo e($emp->email); ?>"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
									</div>
								</div>
								<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?php echo e(url('admin/employees/profile')); ?>/<?php echo e(strtolower($emp->emp_id)); ?>"><?php echo e($emp->firstname); ?></a></h4>
								<div class="small text-muted"><?php echo e($emp->design); ?></div>
								<div class="small text-muted">Employee Id : <?php echo e($emp->emp_id); ?></div>
							</div>
						</div>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</div>
										...
										<div class="col-sm-6">
											...
											<select class="form-select form-control" name="country_code" id="countryname">
												...
												<?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="+ <?php echo e($c->phonecode); ?>" data-id="<?php echo e($c->id); ?>" <?php if($c->iso == 'IN'): ?> selected <?php endif; ?>>+<?php echo e($c->phonecode); ?> <?php echo e(strtolower($c->name)); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
											</div>
										</div>
...
</script><?php /**PATH /home/accessas/public_html/hrms/resources/views/admin/employees.blade.php ENDPATH**/ ?>