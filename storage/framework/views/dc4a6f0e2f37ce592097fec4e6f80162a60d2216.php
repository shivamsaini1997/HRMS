  ...
  <body>
    <div class="main-block">
      ...
      <form action="/dologin" method="POST">
        ...
        <input type="password" name="user_password" id="name" placeholder="Password" required/>
        <hr>
...
</html><?php /**PATH /home/accessas/public_html/elarning/resources/views/admin/login.blade.php ENDPATH**/ ?>