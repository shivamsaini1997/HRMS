							...
							<form action="javascript:void(0)" id="login" method="post">
								...
								<div class="input-block mb-4">
									<div class="row align-items-center">
										...
										<div class="col-auto">
											<a class="text-muted" href="<?php echo e(url('forget-password')); ?>">
												Forgot password?
											</a>
										</div>
									</div>
								...
								<div class="account-footer">
									<p>Don't have an account yet? <a href="<?php echo e(url('signup')); ?>">Register</a></p>
								</div>
							</form>
							<!-- /Account Form -->
...
<?php /**PATH /home/accessas/public_html/hrms/resources/views/frontend/login.blade.php ENDPATH**/ ?>